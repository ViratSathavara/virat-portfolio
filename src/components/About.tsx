...
function StatCard({
  ...
  return (
    <motion.div
      ...
      className="group bg-card border border-border rounded-[var(--radius)] p-4 md:p-7 hover:border-primary/50 transition-all duration-300 hover:shadow-[0_0_28px_hsl(38_90%_55%_/_0.08)]"
    >
...
export function About() {
  ...
  return (
    <section id="about" className="py-16 md:py-32 px-6 relative overflow-hidden" ref={ref}>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <motion.h2
          ...
          className="text-4xl md:text-5xl font-bold tracking-tight text-foreground max-w-2xl mb-6 md:mb-10 leading-tight"
        >
